/****** Object:  StoredProcedure [dbo].[usp_GetUserRolewisePPSIdentyCard]    Script Date: 19-05-2026 12:28:31 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	SELECT ROW_NUMBER() OVER (ORDER BY UserRoleId, DesignationSortOrder) as RowNo,
		...
		'Tel : '+SM.Phone_Number + CASE WHEN SM.Phone_Number2 is not null AND SM.Phone_Number2 <> '' THEN ' / '+RIGHT(SM.Phone_Number2,3) END AS SchoolContactNo,
