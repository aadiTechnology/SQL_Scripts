...
(N'Computers', N'Gain awareness of Artificial Intelligence concepts, applications, and ethics, and engage with interdisciplinary projects', N'Engages in discussions of fairness, bias, privacy, transparency, and responsible AI use; articulates ethical reasoning in simple dilemmas', 2,2),
...
-- Rules:
--   1) Standard filter: Standard_Name = '6'
