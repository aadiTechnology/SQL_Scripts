Declare @SourceVehicleNumber nvarchar(30) ='MH09CV0615', @DestinationVehicleNUmber nvarchar(30)='MH09EM3425'
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND SM.TransportShiftName='09A-PICKUP'
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND SM1.Is_Deleted=0
	   AND VM.VehicleNumber=@SourceVehicleNumber
	   AND SM.TransportShiftName='09B-PICKUP'
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND SM1.Is_Deleted=0
	   AND VM.VehicleNumber=@SourceVehicleNumber
	   AND SM.TransportShiftName='09C-PICKUP'
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND SM1.Is_Deleted=0
	   AND VM.VehicleNumber=@SourceVehicleNumber
	   AND SM.TransportShiftName='09A-DROP'
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND SM1.Is_Deleted=0
	   AND VM.VehicleNumber=@SourceVehicleNumber
	   AND SM.TransportShiftName='09B-DROP'
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND SM1.Is_Deleted=0
	   AND VM.VehicleNumber=@SourceVehicleNumber
	   AND SM.TransportShiftName='09C-DROP'
