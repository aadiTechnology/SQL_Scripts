Declare @SourceVehicleNumber nvarchar(30) ='MH09EM7343', @DestinationVehicleNUmber nvarchar(30)='MH09EM3425'
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND SM.TransportShiftName='12A-PICKUP'
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND SM1.Is_Deleted=0
	   AND VM.VehicleNumber=@SourceVehicleNumber
	   AND SM.TransportShiftName='12B-PICKUP'
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND SM1.Is_Deleted=0
	   AND VM.VehicleNumber=@SourceVehicleNumber
	   AND SM.TransportShiftName='12C-PICKUP'
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where RSTD.Is_Deleted=0
	   ...
	   AND SM1.Is_Deleted=0
	   AND VM.VehicleNumber=@DestinationVehicleNUmber
	   AND TransportShiftName='01-DROP'
	   )s
       ON S.StopName=SM1.StopName
	  Where TTD.AcademicYearId=13
	   AND TTD.SchoolId=122
	   ...
	   AND SM1.Is_Deleted=0
	   AND VM.VehicleNumber=@SourceVehicleNumber
	   AND SM.TransportShiftName='12A-DROP'
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND SM1.Is_Deleted=0
	   AND VM.VehicleNumber=@SourceVehicleNumber
	   AND SM.TransportShiftName='12B-DROP'
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND SM1.Is_Deleted=0
	   AND VM.VehicleNumber=@SourceVehicleNumber
	   AND SM.TransportShiftName='12C-DROP'
