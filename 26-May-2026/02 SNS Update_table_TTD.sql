Declare @SourceVehicleNumber nvarchar(30) ='MH09CV0256', @DestinationVehicleNUmber nvarchar(30)='MH09EM3425'
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND SM.TransportShiftName='31A-PICKUP'
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND SM1.Is_Deleted=0
	   AND VM.VehicleNumber=@SourceVehicleNumber
	   AND SM.TransportShiftName='31B-PICKUP'
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND SM1.Is_Deleted=0
	   AND VM.VehicleNumber=@SourceVehicleNumber
	   AND SM.TransportShiftName='31C-PICKUP'
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND SM1.Is_Deleted=0
	   AND VM.VehicleNumber=@SourceVehicleNumber
	   AND SM.TransportShiftName='31A-DROP'
	--5
UPDATE TTD
      SET TTD.RouteTimingDetailsId = S.RouteTimingDetailsId,
          TTD.UpdatedById = 2,
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND SM1.Is_Deleted=0
	   AND VM.VehicleNumber=@SourceVehicleNumber
	   AND SM.TransportShiftName='31B-DROP'
	--6
UPDATE TTD
      SET TTD.RouteTimingDetailsId = S.RouteTimingDetailsId,
          TTD.UpdatedById = 2,
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND SM1.Is_Deleted=0
	   AND VM.VehicleNumber=@SourceVehicleNumber
	   AND SM.TransportShiftName='31C-DROP'
