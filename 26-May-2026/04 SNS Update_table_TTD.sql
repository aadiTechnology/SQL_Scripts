Declare @SourceVehicleNumber nvarchar(30) ='MH09EM7342', @DestinationVehicleNUmber nvarchar(30)='MH09EM3425'
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND ( SM.TransportShiftName = '06A-PICKUP')
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND SM1.Is_Deleted=0
	   AND VM.VehicleNumber=@SourceVehicleNumber
	   AND ( SM.TransportShiftName = '06B-PICKUP')
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND SM1.Is_Deleted=0
	   AND VM.VehicleNumber=@SourceVehicleNumber
	   AND ( SM.TransportShiftName = '06C-PICKUP')
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND SM1.Is_Deleted=0
	   AND VM.VehicleNumber=@SourceVehicleNumber
	   AND SM.TransportShiftName='06A-DROP'
	   	   AND ( SM.TransportShiftName = '06A-DROP')
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND SM1.Is_Deleted=0
	   AND VM.VehicleNumber=@SourceVehicleNumber
	   AND ( SM.TransportShiftName = '06B-DROP')
--6
UPDATE TTD
      SET TTD.RouteTimingDetailsId = S.RouteTimingDetailsId,
          TTD.UpdatedById = 2,
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND SM1.Is_Deleted=0
	   AND VM.VehicleNumber=@SourceVehicleNumber
	   AND ( SM.TransportShiftName = '06C-DROP')
