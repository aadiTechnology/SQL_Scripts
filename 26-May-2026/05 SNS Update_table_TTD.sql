Declare @SourceVehicleNumber nvarchar(30) ='MH09EM7345', @DestinationVehicleNUmber nvarchar(30)='MH09EM3425'
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND ( SM.TransportShiftName = '35A-PICKUP')
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND SM1.Is_Deleted=0
	   AND VM.VehicleNumber=@SourceVehicleNumber
	   AND ( SM.TransportShiftName = '35B-PICKUP')
   --3
 UPDATE TTD
      SET TTD.RouteTimingDetailsId = S.RouteTimingDetailsId,
          TTD.UpdatedById = 2,
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND SM1.Is_Deleted=0
	   AND VM.VehicleNumber=@SourceVehicleNumber
	   AND ( SM.TransportShiftName = '35C-PICKUP' )
--4
 UPDATE TTD
      SET TTD.RouteTimingDetailsId = S.RouteTimingDetailsId,
          TTD.UpdatedById = 2,
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND SM1.Is_Deleted=0
	   AND VM.VehicleNumber=@SourceVehicleNumber
	   AND ( SM.TransportShiftName = '35A-DROP')
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND SM1.Is_Deleted=0
	   AND VM.VehicleNumber=@SourceVehicleNumber
	   AND ( SM.TransportShiftName = '35B-DROP')
--6
UPDATE TTD
      SET TTD.RouteTimingDetailsId = S.RouteTimingDetailsId,
          TTD.UpdatedById = 2,
...
INNER JOIN Transport.StopMaster SM1
	  ...
	  Where TTD.AcademicYearId=13
	   ...
	   AND SM1.Is_Deleted=0
	   AND VM.VehicleNumber=@SourceVehicleNumber
	   AND ( SM.TransportShiftName = '35C-DROP')
