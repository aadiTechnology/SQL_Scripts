...
AND SFTC.Fee_Type = 'Tuition Fees'
AND SM.Is_Deleted = 'N'
...
UPDATE SSFCM
SET OldStudent_TotalFee = 4500,
	NewStudent_TotalFee = 4500,
	Update_Date = DBO.GetLocalDate(DEFAULT),
	Updated_By_Id = 1
from Schoolwise_Fee_Type_Configuration SFTC
INNER JOIN Schoolwise_Standard_Fee_Configuration_Master SSFCM
...
SELECT Standard_Id, 4, 'Installment - 1', 4620, 0,172,1,0,dbo.GetLocalDate(DEFAULT),1,dbo.GetLocalDate(DEFAULT),1
